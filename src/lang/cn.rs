...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turn off device screen", "息屏(锁定被控端)"),
        ("Screen off command sent", "息屏指令已发送"),
        ("Upload diagnostic logs", "上传诊断日志"),
        ("Upload logs of the selected time range to the diagnostic server", "上传所选时间段的日志到诊断服务器"),
        ("Time range", "时间段"),
        ("Gallery", "相册"),
        ("No media files", "没有媒体文件"),
